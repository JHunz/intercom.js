...
var Intercom=function(){var g=function(){};g.createInterface=function(a){return{on:function(b,c){"undefined"===typeof this[a]&&(this[a]={});this[a].hasOwnProperty(b)||(this[a][b]=[]);this[a][b].push(c)},off:function(b,c){"undefined"!==typeof this[a]&&this[a].hasOwnProperty(b)&&h.removeItem(c,this[a][b])},trigger:function(b){if("undefined"!==typeof this[a]&&this[a].hasOwnProperty(b))for(var c=Array.prototype.slice.call(arguments,1),d=0;d<this[a][b].length;d++)this[a][b][d].apply(this[a][b][d],c)}}};
var n=g.createInterface("_handlers");g.prototype._on=n.on;g.prototype._off=n.off;g.prototype._trigger=n.trigger;var p=g.createInterface("handlers");g.prototype.on=function(){p.on.apply(this,arguments);Array.prototype.unshift.call(arguments,"on");this._trigger.apply(this,arguments)};g.prototype.off=p.off;g.prototype.trigger=p.trigger;var f=window.localStorage;"undefined"===typeof f&&(f={getItem:function(){},setItem:function(){},removeItem:function(){}});var h={};h.guid=function(){var a=function(){return(65536*
